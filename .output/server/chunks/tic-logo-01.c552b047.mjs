...
`,
    values: [
      {
        id: 1,
        title: "Vision",
        text: "To be the preferred solution provider in the MENA region, leading the local and regional market in Inspections and Calibration services by introducing innovative service to our client.",
        icon: LifebuoyIcon
      },
      {
        id: 2,
        title: "Mission",
        text: "To succeed we must evolve, stay committed to our sold work ethics, have a passion to keep current with the newest of innovation of our industry, and continually strive to find new and better ways of working. Our goal is to provide the right services and solutions, in the right setting, at the right time.",
        icon: NewspaperIcon
      },
      {
        id: 3,
        title: "Core Values",
        text: "To create a sustainable growth, we believe in the foundational commitment of social responsibility being at the heart of our operation which includes accountability, and integrity.",
        icon: PhoneIcon
      }
    ],
    compliance: {
    ...
    team: {
      title: "Our team",
      text: "Our diverse team are skilfully trained individuals, we strive to consistently deliver innovative quality control services and customized solutions to all our clients and industries that we operate in. We also believe in the importance of on-going training and education throughout our team\u2019s employment here at TIC Quality Control.",
      subtitle: "We choose the best:",
      values: [
        {
          id: 1,
  ...
  categories: [
    {
      ...
      `,
            ...
            {
              id: 2,
              title: "Pressure Vessel and Tanks",
              text: `
      ...
      `,
            ...
            {
              id: 3,
              title: "Reactors, Storage Tanks Manufacturing",
              text: `
      ...
      `,
            ...
            {
              id: 6,
              title: "Offshore Jackets - Oil Rigs - Windmills",
              text: `
          ...
          details: [
            {
              id: 1,
              title: "",
              text: `<p>We provide systematic methods to help businesses to have better control and track their food supply chain. With a strong focus on response turnaround times, efficiency, urgencies, and specific food safety issues, we are committed to the pursuit of inspecting and handing out fair reports of any food samples coming to our laboratories through scientific procedures, and standardized compliance regulations.&nbsp;</p>
      ...
      `,
              image: "Contaminants Testing"
            },
            {
              id: 2,
              title: "Physical Testing",
              text: `<p>Physical testing refers to the test methods used to evaluate the different physical properties of a food product and a indicator of its quality, and product consistency. Commonly tested properties of food include colour, size and thickness, weight and texture, viscosity and the texture of the granulation to name a few.</p>
                  `,
              image: ""
            },
            {
              id: 3,
              title: "Chemistry and Nutritional Analysis",
              text: `
      ...
      `,
            ...
            {
              id: 3,
              title: "Inspection & Tested Vegoils (RBD/Crude)",
              text: ` 
                  <ul role="list">
    ...
    },
    {
      ...
      featured: [
        ...
        },
        {
          ...
          text: "Calibration is critically important when measurements are important, they simply work hand in hand, the cost of calibration to your equipment as an investment and the potential result of an incorrect reading is a cost at the result of not making the investment.",
          more: true,
          apply: false,
        ...
        },
        {
          ...
          text: "Corrosion is the process of decay on a material caused by a chemical or electrochemical reaction with their environment, exposure of surfaces which come into contact with gas or liquid, and the process is accelerated by exposure to warm temperatures, acids and salts.",
          more: true,
          apply: false,
        ...
        },
        {
          ...
          text: "Steel manufacturing and fabrication is an important trade catering to almost all industrial sectors. Steel products are essential to industries such as transportation, construction, energy, agriculture, mining, and consumer goods manufacturing.",
          more: true,
          apply: false,
        ...
        },
        {
          ...
          details: [
            {
              id: 1,
              title: "Petroleum Quality Control",
              text: `
            ...
            {
              id: 2,
              title: "Why Petroleum Testing Important?",
              text: `
            ...
            {
              id: 3,
              title: "Industries Which Can Benefit from Testing Services:",
              text: `
                    <ul role="list">
            ...
            {
              id: 4,
              title: "Our Petroleum Laboratory Capabilities",
              text: `
            ...
            {
              id: 7,
              title: "Our Chemical Testing Laboratory Capabilities",
              text: `
...
const _imports_0 = "" + globalThis.__buildAssetsURL("tic-logo-01.af8bd44a.svg");

export { _imports_0 as _, data as d };
//# sourceMappingURL=tic-logo-01.c552b047.mjs.map
